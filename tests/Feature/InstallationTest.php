...
test('installer welcome is available when not installed', function () {
    $this->get('/install')
        ...
        ->assertSee(__('installer.tagline'), false)
        ->assertDontSee('install-shell__brand', false)
        ...
        ->assertSee(__('installer.steps.store'), false)
        ->assertSee(__('installer.steps.catalog'), false)
        ->assertSee(__('installer.steps.regional'), false)
        ->assertSee(__('installer.steps.branding'), false)
        ->assertSee(__('installer.steps.theme'), false)
