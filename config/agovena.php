...
return [
    ...
    'packages' => [
        ...
        'monorepo' => [
            ...
            'default_ref' => env('AGOVENA_PACKAGES_MONOREPO_REF', 'ca5a5b3116473f62108d6cf519b5ca07d8ec10cf'),
            'packages' => [
                ...
                'cloudflare-domain' => ['kind' => 'extension', 'path' => 'extensions/domains/cloudflare-domain'],
                'namecheap-domain' => ['kind' => 'extension', 'path' => 'extensions/domains/namecheap-domain'],
                ...
                'paddle' => ['kind' => 'extension', 'path' => 'extensions/payments/paddle'],
                'tebex' => ['kind' => 'extension', 'path' => 'extensions/payments/tebex'],
                ...
                'cpanel' => ['kind' => 'extension', 'path' => 'extensions/provisioning/cpanel'],
                'convoy' => ['kind' => 'extension', 'path' => 'extensions/provisioning/convoy'],
                'directadmin' => ['kind' => 'extension', 'path' => 'extensions/provisioning/directadmin'],
                'enhance' => ['kind' => 'extension', 'path' => 'extensions/provisioning/enhance'],
                'plesk' => ['kind' => 'extension', 'path' => 'extensions/provisioning/plesk'],
                'virtfusion' => ['kind' => 'extension', 'path' => 'extensions/provisioning/virtfusion'],
                'virtualizor' => ['kind' => 'extension', 'path' => 'extensions/provisioning/virtualizor'],
