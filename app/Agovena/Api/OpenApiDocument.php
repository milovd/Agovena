            ...
            'components' => [
                'securitySchemes' => [
                    'bearerAuth' => [
                        ...
                        'scheme' => 'bearer',
                        'bearerFormat' => 'token',
                        'description' => 'Use a named API token. Required route abilities are exposed as x-required-ability on protected operations.',
                    ],
                    'cartToken' => [
                        'type' => 'apiKey',
                        'in' => 'header',
                ...
                'x-api-token-abilities' => array_map(
                    static fn (array $definition): array => [
                        'key' => $definition['key'],
                        'group' => $definition['group'],
                        'action' => $definition['action'],
                    ],
                    ApiTokenAbilities::definitions(),
                ),
            ],
            'paths' => [
                '/openapi.json' => [
                ...
                '/auth/tokens' => [
                                ...
                                'application/json' => [
                                    'schema' => [
                                        ...
                                        'properties' => [
                                            ...
                                            'abilities' => [
                                                'type' => 'array',
                                                'items' => ['type' => 'string', 'enum' => ApiTokenAbilities::keys()],
                                                'description' => 'Optional. Omit for full access; use explicit abilities for least privilege.',
                                            ],
                                        ],
                                    ],
                                ],
                    ...
                    'delete' => [
                        ...
                        'security' => [['bearerAuth' => []]],
                        'x-required-ability' => 'tokens.revoke',
                ...
                '/me' => [
                    'get' => [
                        ...
                        'security' => [['bearerAuth' => []]],
                        'x-required-ability' => 'account.read',
                    ...
                    'patch' => [
                        ...
                        'summary' => 'Update name',
                        'security' => [['bearerAuth' => []]],
                        'x-required-ability' => 'account.update',
                        'responses' => ['200' => ['description' => 'Account']],
                    ],
                ],
                '/addresses' => [
                    'get' => [
                        ...
                        'security' => [['bearerAuth' => []]],
                        'x-required-ability' => 'addresses.read',
                    ...
                    'post' => [
                        ...
                        'security' => [['bearerAuth' => []]],
                        'x-required-ability' => 'addresses.create',
                ...
                '/addresses/{address}' => [
                    'patch' => [
                        ...
                        'security' => [['bearerAuth' => []]],
                        'x-required-ability' => 'addresses.update',
                    ...
                    'delete' => [
                        ...
                        'security' => [['bearerAuth' => []]],
                        'x-required-ability' => 'addresses.delete',
                ...
                '/checkout' => [
                    'post' => [
                        ...
                        'security' => [['bearerAuth' => []]],
                        'x-required-ability' => 'orders.create',
                ...
                '/invoices' => [
                    'get' => [
                        ...
                        'summary' => 'Invoices',
                        'security' => [['bearerAuth' => []]],
                        'x-required-ability' => 'invoices.read',
                ...
                '/credit-notes' => [
                    'get' => [
                        ...
                        'security' => [['bearerAuth' => []]],
                        'x-required-ability' => 'credit_notes.read',
                ...
                '/support-tickets' => [
                    'get' => [
                        ...
                        'security' => [['bearerAuth' => []]],
                        'x-required-ability' => 'tickets.read',
                ...
                '/services' => [
                    'get' => [
                        ...
                        'security' => [['bearerAuth' => []]],
                        'x-required-ability' => 'services.read',
                        'responses' => [
                ...
                '/services/{instance}' => [
                    'get' => [
                        'tags' => ['Commerce'],
                        'summary' => 'Service detail (when the Provisioning module is enabled)',
                        'security' => [['bearerAuth' => []]],
                        'x-required-ability' => 'services.read',
                        'responses' => ['200' => ['description' => 'Service'], '404' => ['description' => 'Capability unavailable']],
                    ],
                ],
                '/downloads' => [
                    'get' => [
                        ...
                        'security' => [['bearerAuth' => []]],
                        'x-required-ability' => 'downloads.read',
                        'responses' => [
                ...
                '/downloads/{token}' => [
                    'get' => [
                        'tags' => ['Commerce'],
                        'summary' => 'Download file (when the Downloads module is enabled)',
                        'security' => [['bearerAuth' => []]],
                        'x-required-ability' => 'downloads.read',
                        'responses' => ['200' => ['description' => 'Download'], '404' => ['description' => 'Capability unavailable']],
                    ],
                ],
                '/digital-secrets' => [
                    'get' => [
                        ...
                        'security' => [['bearerAuth' => []]],
                        'x-required-ability' => 'digital_secrets.read',
                        'responses' => [
                ...
                '/event-tickets' => [
                    'get' => [
                        ...
                        'security' => [['bearerAuth' => []]],
                        'x-required-ability' => 'event_tickets.read',
                        'responses' => [
                ...
                '/event-tickets/{token}' => [
                    'get' => [
                        'tags' => ['Commerce'],
                        'summary' => 'Event ticket detail (when the Events module is enabled)',
                        'security' => [['bearerAuth' => []]],
                        'x-required-ability' => 'event_tickets.read',
                        'responses' => ['200' => ['description' => 'Event ticket'], '404' => ['description' => 'Capability unavailable']],
                    ],
                ],
            ],
        ];
