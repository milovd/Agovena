    ...
    private function aliases(string $source, string $entity): array
    {
        ...
        return match ($entity) {
            ...
            'order' => [
                ...
                'billing_company' => ['billing_company', 'company_name'],
                'billing_line1' => ['billing_line1', 'billing_address', 'address'],
                'billing_line2' => ['billing_line2', 'billing_address2', 'address2'],
                'billing_city' => ['billing_city', 'city'],
                'billing_region' => ['billing_region', 'billing_state', 'state', 'region'],
                'billing_postal_code' => ['billing_postal_code', 'billing_zip', 'postal_code', 'zip'],
                'billing_country' => ['billing_country', 'country'],
                'billing_phone' => ['billing_phone', 'phone'],
                'shipping_name' => ['shipping_name'],
                'shipping_company' => ['shipping_company'],
                'shipping_line1' => ['shipping_line1', 'shipping_address'],
                'shipping_line2' => ['shipping_line2', 'shipping_address2'],
                'shipping_city' => ['shipping_city'],
                'shipping_region' => ['shipping_region', 'shipping_state'],
                'shipping_postal_code' => ['shipping_postal_code', 'shipping_zip'],
                'shipping_country' => ['shipping_country'],
                'shipping_phone' => ['shipping_phone'],
                'shipping_same_as_billing' => ['shipping_same_as_billing'],
                'custom_properties_json' => ['custom_properties_json', 'properties_json', 'custom_properties'],
            ],
            'subscription' => [
