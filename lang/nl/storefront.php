...
return [
    ...
    'cookie_consent' => [
        ...
        'lead' => 'We gebruiken cookies om deze site bruikbaar te houden en, als je dat toelaat, om ons verkeer te analyseren. Informatie over je gebruik van deze site kan worden gedeeld met de geconfigureerde analyticssoftware, die die gegevens kan combineren met andere informatie die je aan die dienst hebt verstrekt of die de dienst heeft verzameld via jouw gebruik van haar diensten. Deze site gebruikt geen marketing- of socialmedia-advertentiecookies.',
        'policy' => 'Cookiebeleid',
        'privacy' => 'Privacy',
        'reject' => 'Enkel essentieel',
        'customize' => 'Keuze aanpassen',
        'accept' => 'Alles toestaan',
        'close' => 'Sluiten',
        'tab_consent' => 'Toestemming',
        'tab_about' => 'Over',
        'essential' => 'Noodzakelijk',
        'essential_description' => 'Noodzakelijke cookies helpen een website bruikbaar te maken door basisfuncties mogelijk te maken, zoals paginanavigatie en toegang tot beveiligde zones. De website kan zonder deze cookies niet goed functioneren.',
        'essential_locked' => 'Noodzakelijke cookies kun je niet uitschakelen. Ze bewaren je taalvoorkeur en cookiekeuze zodat de site werkt en je beslissing onthoudt. Voor deze cookies is volgens de GDPR geen toestemming vereist.',
        'analytics' => 'Analytics',
        'analytics_description' => 'Analytics-cookies helpen Agovena te begrijpen hoe bezoekers deze site gebruiken (bekeken pagina’s, geschatte locatie, apparaat/browser en verwijzingsbron). Ze worden geleverd door de geconfigureerde analyticssoftware en laden pas nadat je toestemt.',
        ...
        'consent_meta_empty' => 'Nog geen cookiekeuze opgeslagen.',
        'consent_meta' => 'Consent-ID: :id · Datum: :date',
        'saved_choice' => 'Je cookievoorkeur is opgeslagen.',
        'save_error' => 'Je voorkeur kon niet worden opgeslagen. Probeer het opnieuw.',
    ],
    ...
    'checkout' => [
        ...
        'renewal_mode' => 'Hoe moet deze service worden hernieuwd?',
        'renewal_manual' => 'Handmatig hernieuwen',
        'renewal_manual_help' => 'We maken vóór de hernieuwingsdatum een invoice. Je kiest zelf de betaalmethode en betaalt die invoice.',
        'renewal_automatic' => 'Automatisch hernieuwen',
        'renewal_automatic_help' => 'Mollie gebruikt, wanneer beschikbaar, het goedgekeurde betaalmandaat voor volgende hernieuwingen.',
        ...
        'store_credit' => 'Accountsaldo',
        'apply_store_credit' => 'Accountsaldo gebruiken (:amount)',
        'credit_applied' => 'Accountsaldo',
    ...
    'product' => [
        ...
        'back_in_stock_action' => 'Meld mij',
        'back_in_stock_subscribed' => 'Je ontvangt een e-mail wanneer dit product weer op voorraad is.',
        'back_in_stock_rate_limited' => 'Wacht even voordat je opnieuw een voorraadmelding aanvraagt.',
    ...
    'errors' => [
        ...
        'payment_gateway_required' => 'Er is een betaalgateway nodig voor het restbedrag. Installeer en activeer een betaal-extension, of betaal het volledige bedrag met accountsaldo.',
        'automatic_renewal_unavailable' => 'Automatisch hernieuwen kan alleen met een betaalmethode die recurring charges ondersteunt. Kies handmatig hernieuwen of selecteer Mollie.',
        'account_balance_insufficient' => 'Je hebt niet genoeg accountsaldo om deze bestelling te betalen.',
