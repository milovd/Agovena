...
return [
    ...
    'welcome' => [
        ...
        'lede' => 'A short setup for admin access, store identity, and storefront essentials. You can refine everything later in Admin.',
        'overview_title' => 'What you will set up',
        'account_title' => 'Admin access',
        'account_text' => 'Create the owner account that will manage Agovena.',
        'store_title' => 'Store foundation',
        'store_text' => 'Choose your store name, selling capabilities, and regional defaults.',
        ...
        'technical_summary' => 'Need the technical checklist?',
