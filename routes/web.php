...
use App\Livewire\Customer\Account\Security as CustomerSecurity;
...
Route::middleware(['auth', 'abuse'])->prefix('account')->name('customer.')->group(function (): void {
    ...
    Route::middleware('customer.verified')->group(function (): void {
        ...
        Route::get('/security', CustomerSecurity::class)->name('security');
...
Route::middleware(['auth', 'abuse', SyncStaffPermissions::class, 'admin.access', 'admin.2fa'])->prefix('admin')->name('admin.')->group(function (): void {
    ...
    Route::redirect('/users', '/admin/customers')->name('users.index');
    Route::get('/roles', RolesIndex::class)->name('roles.index');
    Route::redirect('/staff', '/admin/customers')->name('staff.index');
